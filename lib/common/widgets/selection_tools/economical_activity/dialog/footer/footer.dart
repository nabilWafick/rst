                        ...
                        Consumer(
                          builder: (context, ref, child) {
                            ...
                            return Container(
                              ...
                              child: RSTText(
                                text: data != 0
                                    ? '${((economicalActivitiesSelectionListParameters['skip'] + 15) / 15).toInt()}'
                                    : '0',
                                fontSize: 14.0,
                    ...
                    return RSTText(
                      text: economicalActivitiesSelectionList.when(
                        data: (data) => data.isNotEmpty
                            ? '${economicalActivitiesSelectionListParameters['skip'] + 1}'
                            : '0',
                        error: (error, stackTrace) => '',
                        loading: () => '',
                      ),
                ...
                Consumer(
                  builder: (context, ref, child) {
                    ...
                    return RSTText(
                      text: economicalActivitiesSelectionList.when(
                        data: (data) =>
                            '${economicalActivitiesSelectionListParameters['skip'] + data.length}',
                        error: (error, stackTrace) => '',
                        loading: () => '',
                      ),
                      fontSize: 12.0,

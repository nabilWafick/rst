...
Future<void> generateCollectorsCollectionsPdf({
...
// hide Export button
  ...
  try {
            ...
            pw.TableRow(
              children: [
                ...
                pw.Container(
                  ...
                  child: pw.Text(
                    collectorsCollections[i].totalCollections.toString(),
                    style: pw.TextStyle(
                      font: regularFont,
                      fontSize: 7,
                    ),
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          buildDataTable(
            collectorsCollections: collectorsCollections,
          ),
        ],
      ),
    );
    ...
    final file = File('${output.path}/collectes_periodiques.pdf');

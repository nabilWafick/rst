...
import 'package:rst/modules/statistics/collectors_collections/functions/pdf/pdf_file.function.dart';
import 'package:rst/modules/statistics/collectors_collections/providers/collectors_collections.provider.dart';
import 'package:rst/utils/colors/colors.util.dart';

class CollectorsCollectionsPdfGenerationDialog extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final exportSelectionnedCollectorsCollections = useState<bool>(true);
      ...
      content: Container(
        ...
        child: Column(
          ...
          children: [
            SwitchListTile(
              ...
              onChanged: (value) {
                if (value) {
                  ...
                  exportSelectionnedCollectorsCollections.value = !value;
                } else {
                  exportAllCollectorsCollections.value = value;
                  exportSelectionnedCollectorsCollections.value = !value;
                }
            ...
            SwitchListTile(
              value: exportSelectionnedCollectorsCollections.value,
              title: const RSTText(
                      ...
                      onPressed: () async {
                        ...
                        if (exportAllCollectorsCollections.value) {
                          ...
                          await generateCollectorsCollectionsPdf(
                            ...
                            listParameters: {
                              'skip': 0,
                              'take': collectorsCollectionsCount.data.count,
                            },
                          ...
                          await generateCollectorsCollectionsPdf(
                            context: context,
                            ref: ref,
                            listParameters: collectorsCollectionsListParameters,
                            showPrintButton: showPrintButton,
                          );
                        }
                      },

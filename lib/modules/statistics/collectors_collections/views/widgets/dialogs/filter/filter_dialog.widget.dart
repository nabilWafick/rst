...
class CollectorsCollectionsFilterDialog extends StatefulHookConsumerWidget {
...
class _CollectorsCollectionsFilterDialogState
    extends ConsumerState<CollectorsCollectionsFilterDialog> {
    ...
    return AlertDialog(
      ...
      actions: [
        Row(
          ...
          children: [
            collectorsCollectionsListFilterParametersAdded.isNotEmpty
                ? SizedBox(
                    width: 170.0,

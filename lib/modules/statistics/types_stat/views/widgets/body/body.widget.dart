...
class TypesStatsPageBody extends StatefulHookConsumerWidget {
  const TypesStatsPageBody({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _TypesStatsPageBodyState();
}

class _TypesStatsPageBodyState extends ConsumerState<TypesStatsPageBody> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    final typesStatsList = ref.watch(typesStatsListStreamProvider);
              ...
              return Row(
                children: [
                  ...
                  Container(
                    ...
                    height: 30.0,
                    child: RSTText(
                      text: typeStat.cards.length.toString(),
                      fontSize: 12.0,
                      fontWeight: FontWeight.w500,
                    ),
                  ),
                  Container(
                    ...
                    height: 30.0,
                    child: RSTText(
                      text: format.format(typeStat.createdAt),
                      fontSize: 12.0,
                      fontWeight: FontWeight.w500,
                    ),
                  ),
                  Container(
                    ...
                    height: 30.0,
                    child: RSTText(
                      text: format.format(typeStat.updatedAt),
                      fontSize: 12.0,
                      fontWeight: FontWeight.w500,
                    ),
                  ),

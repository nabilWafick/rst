...
import 'package:rst/modules/statistics/products_improvidence/functions/pdf/pdf_file.function.dart';
import 'package:rst/modules/statistics/products_improvidence/providers/products_improvidence.provider.dart';
import 'package:rst/utils/colors/colors.util.dart';

class ProductsImprovidencePdfGenerationDialog extends HookConsumerWidget {
  const ProductsImprovidencePdfGenerationDialog({
    super.key,
  });
  @override
                    ...
                    child: RSTElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (exportAllProductsImprovidence.value) {
                          ...
                          // generate excel file
                          await generateProductsImprovidencePdf(
                            context: context,
                            ref: ref,

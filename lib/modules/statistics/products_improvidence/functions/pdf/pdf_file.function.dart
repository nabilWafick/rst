...
import 'package:rst/modules/statistics/products_improvidence/models/products_improvidence.model.dart';
import 'package:rst/utils/utils.dart';
import 'package:rst/common/widgets/pdf_info/pdf_info.info.dart';

Future<void> generateProductsImprovidencePdf({
...
// hide Export button
  ...
  try {
    ...
    pw.Widget buildDataTable({
      required List<ProductImprovidence> productsImprovidence,
    }) {
      return pw.Table(
            ...
            pw.TableRow(
              children: [
                pw.Container(
                  ...
                  child: pw.Text(
                    productsImprovidence[i].productName,
                    style: pw.TextStyle(
                      font: regularFont,
                      fontSize: 7,
                    ),
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          buildDataTable(
            productsImprovidence: productsImprovidence,
          ),
        ],
      ),
    );

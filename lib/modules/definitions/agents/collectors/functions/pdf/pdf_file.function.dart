...
Future<void> generateCollectorsPdf({
...
// hide Export button
  ...
  try {
    ...
    pw.Widget buildDataTable({
      required List<Collector> collectors,
    }) {
      return pw.Table(
            ...
            pw.TableRow(
              children: [
                ...
                pw.Container(
                  ...
                  child: pw.Text(
                    format.format(collectors[i].createdAt),
                    style: pw.TextStyle(
                      font: regularFont,
                      fontSize: 7,
                    ),
                ...
                pw.Container(
                  ...
                  child: pw.Text(
                    format.format(collectors[i].updatedAt),
                    style: pw.TextStyle(
                      font: regularFont,
                      fontSize: 7,
                    ),
    ...
    final file = File('${output.path}/collecteurs.pdf');

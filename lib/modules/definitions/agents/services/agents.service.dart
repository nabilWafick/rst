    ...
    try {
      ...
      return ServiceResponse(
        ...
        message: ServiceMessage(
          en: 'The agent have been added successfully',
          fr: 'L\'agent a été ajouté avec succès',
        ),
      );
  ...
  static Future<ServiceResponse> update({
    ...
    try {
      ...
      return ServiceResponse(
        ...
        message: ServiceMessage(
          en: 'The agent have been updated successfully',
          fr: 'L\'agent a été mis à jour avec succès',
        ),
      );
    } on DioException catch (error) {
      if (error.response != null) {
  ...
  static Future<ServiceResponse> delete({
    ...
    try {
      ...
      return ServiceResponse(
        ...
        message: ServiceMessage(
          en: 'The agent have been deleted successfully',

...
class AgentsPageBody extends StatefulHookConsumerWidget {
  const AgentsPageBody({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _AgentsPageBodyState();
}

class _AgentsPageBodyState extends ConsumerState<AgentsPageBody> {
  @override
  void initState() {
    super.initState();
              ...
              return Row(
                children: [
                            ...
                            ? RSTToolTipOption(
                                ...
                                onTap: () async {
                                  FunctionsController.showAlertDialog(
                                    context: context,
                                    alertDialog:
                                        AgentDisconnectionConfirmationDialog(
                                      agent: agent,
                                      confirmToDisconnect:
                  ...
                  Container(
                    ...
                    height: 30.0,
                    child: RSTText(
                      text: format.format(agent.createdAt),
                      fontSize: 12.0,
                      fontWeight: FontWeight.w500,
                    ),
                  ),

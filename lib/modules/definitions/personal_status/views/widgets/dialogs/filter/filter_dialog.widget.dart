...
class PersonalStatusFilterDialog extends StatefulHookConsumerWidget {
    ...
    return AlertDialog(
                      ...
                      (state) {
                        state = {
                          ...
                          DateTime.now().millisecondsSinceEpoch: {
                            PersonalStatusStructure.name.back: {
      ...
      actions: [
        Row(
          ...
          children: [
            personalStatusListFilterParametersAdded.isNotEmpty
                ? SizedBox(
                    width: 170.0,

...
import 'package:rst/modules/definitions/personal_status/functions/excel/excel_file.function.dart';
import 'package:rst/modules/definitions/personal_status/providers/personal_status.provider.dart';
import 'package:rst/utils/colors/colors.util.dart';

class PersonalStatusExcelFileGenerationDialog extends HookConsumerWidget {
                    ...
                    child: RSTElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (exportAllPersonalStatus.value) {
                          ...
                          // generate excel file
                          await generatePersonalStatusExcelFile(
                            context: context,
                            ref: ref,
                            listParameters: {
                              'skip': 0,

...
class PersonalStatusSortDialog extends HookConsumerWidget {
  const PersonalStatusSortDialog({
    super.key,
  });
  @override
    ...
    return AlertDialog(
        ...
        child: Column(
          ...
          children: [
            ConstrainedBox(
              ...
              child: personalStatusListParameters.containsKey('orderBy')
                  ? Consumer(
            ...
            showSortParameters.value
                ? ConstrainedBox(
                    ...
                    child: Wrap(
                      children: personalStatusListParameters
                              .containsKey('orderBy')
      ...
      actions: [
        Row(
          ...
          children: [
            personalStatusListParameters['orderBy']?.isNotEmpty ?? false
                ? SizedBox(
                    width: 170.0,
            ...
            SizedBox(
              width: 170.0,
              child: RSTElevatedButton(
                text: personalStatusListParameters['orderBy']?.isEmpty ?? false
                    ? 'Valider'
                    : 'Fermer',
                onPressed: () async {
                  Navigator.of(context).pop();

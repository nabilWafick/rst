...
Future<void> generateEconomicalActivitiesPdf({
...
// hide Export button
  ...
  try {
    ...
    // Get economicalActivities list
    final economicalActivitiesList =
        await EconomicalActivitiesController.getMany(
    ...
    pw.Widget buildHeader() {
      return pw.Column(
        ...
        children: [
          ...
          pw.Text(
            'LISTE DES economicalActivitIES',
            style: pw.TextStyle(
              font: mediumFont,
              fontSize: 10.0,
              fontWeight: pw.FontWeight.bold,
    ...
    pw.Widget buildDataTable({
      required List<EconomicalActivity> economicalActivities,
    }) {
      return pw.Table(
        ...
        children: [
          ...
          for (int i = 0; i < economicalActivities.length; ++i)
            pw.TableRow(
              children: [
                pw.Container(
                  margin: const pw.EdgeInsets.symmetric(
                ...
                pw.Container(
                  ...
                  child: pw.Text(
                    format.format(economicalActivities[i].createdAt),
                    style: pw.TextStyle(
                      font: regularFont,
                      fontSize: 7,
                    ),
                ...
                pw.Container(
                  ...
                  child: pw.Text(
                    format.format(economicalActivities[i].updatedAt),
                    style: pw.TextStyle(
                      font: regularFont,
                      fontSize: 7,
                    ),
    ...
    final economicalActivities =
        List<EconomicalActivity>.from(economicalActivitiesList.data);
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          buildDataTable(
            economicalActivities: economicalActivities,
          ),
        ],
      ),
    );
    ...
    final file = File('${output.path}/activites_economiques.pdf');

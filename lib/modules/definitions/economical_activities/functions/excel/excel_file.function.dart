...
Future<void> generateEconomicalActivitiesExcelFile({
  ...
  try {
    ...
    for (int i = 0; i < economicalActivities.length; i++) {
      sheet
          ...
          .value = TextCellValue(economicalActivities[i].name);
      ...
      sheet
              ...
              .value =
          TextCellValue(format.format(economicalActivities[i].createdAt));
      ...
      sheet
              ...
              .value =
          TextCellValue(format.format(economicalActivities[i].updatedAt));
    }
    ...
    String filePath = '${directory.path}/activites_economiques.xlsx';

...
class EconomicalActivitySortDialog extends HookConsumerWidget {
  const EconomicalActivitySortDialog({
    super.key,
  });
  @override
    ...
    return AlertDialog(
        ...
        child: Column(
          ...
          children: [
            ConstrainedBox(
              ...
              child: economicalActivitiesListParameters.containsKey('orderBy')
                  ? Consumer(
            ...
            showSortParameters.value
                ? ConstrainedBox(
                    ...
                    child: Wrap(
                      children: economicalActivitiesListParameters
                              .containsKey('orderBy')
      ...
      actions: [
        Row(
          ...
          children: [
            economicalActivitiesListParameters['orderBy']?.isNotEmpty ?? false
                ? SizedBox(
                    width: 170.0,
            ...
            SizedBox(
              width: 170.0,
              child: RSTElevatedButton(
                text: economicalActivitiesListParameters['orderBy']?.isEmpty ??
                        false
                    ? 'Valider'
                    : 'Fermer',
                onPressed: () async {

...
class EconomicalActivitiesPageBody extends StatefulHookConsumerWidget {
  const EconomicalActivitiesPageBody({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _EconomicalActivitiesPageBodyState();
}

class _EconomicalActivitiesPageBodyState
    extends ConsumerState<EconomicalActivitiesPageBody> {
  @override
  void initState() {
    super.initState();
                        ...
                        RSTToolTipOption(
                          ...
                          onTap: () {
                            FunctionsController.showAlertDialog(
                              context: context,
                              alertDialog: EconomicalActivitySimpleView(

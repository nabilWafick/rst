...
class EconomicalActivityUpdateConfirmationDialog extends HookConsumerWidget {
  ...
  const EconomicalActivityUpdateConfirmationDialog({
    super.key,
        ...
        child: Row(
          children: [
            ...
            const Flexible(
              child: RSTText(
                text:
                    'Êtes-vous sûr de vouloir modifier les données de cette activité économique ?',
                fontSize: 15.0,

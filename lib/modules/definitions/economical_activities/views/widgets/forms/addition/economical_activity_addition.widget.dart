...
class EconomicalActivityAdditionForm extends StatefulHookConsumerWidget {
  const EconomicalActivityAdditionForm({super.key});
  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _EconomicalActivityAdditionFormState();
}

class _EconomicalActivityAdditionFormState
    extends ConsumerState<EconomicalActivityAdditionForm> {
  final formKey = GlobalKey<FormState>();
  @override
  Widget build(BuildContext context) {
    final showValidatedButton = useState<bool>(true);
    const formCardWidth = 500.0;
    //  final economicalActivityPicture = ref.watch(economicalActivityPhotoProvider);
    return AlertDialog(
                    ...
                    Container(
                      ...
                      child: Center(
                        child: InkWell(
                          ...
                          child: economicalActivityPicture == null
                              ? const Icon(
                                  Icons.photo,
                                  size: 150.0,
                                  color: RSTColors.primaryColor,
            ...
            showValidatedButton.value
                ? SizedBox(
                    ...
                    child: RSTElevatedButton(
                      text: 'Valider',
                      onPressed: () async {
                        await EconomicalActivitiesCRUDFunctions.create(
                          context: context,
                          formKey: formKey,
                          ref: ref,

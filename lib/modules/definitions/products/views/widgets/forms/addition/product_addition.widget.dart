...
class ProductAdditionForm extends StatefulHookConsumerWidget {
  const ProductAdditionForm({super.key});
  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _ProductAdditionFormState();
}

class _ProductAdditionFormState extends ConsumerState<ProductAdditionForm> {
            ...
            showValidatedButton.value
                ? SizedBox(
                    ...
                    child: RSTElevatedButton(
                      text: 'Valider',
                      onPressed: () async {
                        await ProductsCRUDFunctions.create(
                          context: context,
                          formKey: formKey,
                          ref: ref,

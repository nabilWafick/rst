...
// hide Export button
  ...
  try {
            ...
            pw.TableRow(
              children: [
                ...
                pw.Container(
                  ...
                  child: pw.Text(
                    format.format(cards[i].createdAt),
                    style: pw.TextStyle(
                      font: regularFont,
                      fontSize: 7,
                    ),
                ...
                pw.Container(
                  ...
                  child: pw.Text(
                    format.format(cards[i].updatedAt),
                    style: pw.TextStyle(
                      font: regularFont,
                      fontSize: 7,
                    ),
    ...
    final file = File('${output.path}/cartes.pdf');

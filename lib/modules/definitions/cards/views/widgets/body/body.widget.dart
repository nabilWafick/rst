...
class CardsPageBody extends StatefulHookConsumerWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _CardsPageBodyState();
}

class _CardsPageBodyState extends ConsumerState<CardsPageBody> {
  @override
  void initState() {
    super.initState();
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: RSTText(
                      text: FunctionsController.truncateText(
                        text:
                            '${card.customer.name} ${card.customer.firstnames}',
                        maxLength: 45,
                      ),
                      fontSize: 12.0,
                      fontWeight: FontWeight.w500,
                  ...
                  Container(
                    ...
                    height: 30.0,
                    child: RSTText(
                      text: card.repaidAt != null
                          ? format.format(card.repaidAt!)
                          : '',
                      fontSize: 12.0,
                      fontWeight: FontWeight.w500,
                    ),
                  ...
                  Container(
                    ...
                    height: 30.0,
                    child: RSTText(
                      text: card.satisfiedAt != null
                          ? format.format(card.satisfiedAt!)
                          : '',
                      fontSize: 12.0,
                      fontWeight: FontWeight.w500,
                    ),
                  ...
                  Container(
                    ...
                    height: 30.0,
                    child: RSTText(
                      text: card.transferredAt != null
                          ? format.format(card.transferredAt!)
                          : '',
                      fontSize: 12.0,
                      fontWeight: FontWeight.w500,
                    ),
                  ...
                  Container(
                    ...
                    height: 30.0,
                    child: RSTText(
                      text: format.format(card.createdAt),
                      fontSize: 12.0,
                      fontWeight: FontWeight.w500,
                    ),
                  ),

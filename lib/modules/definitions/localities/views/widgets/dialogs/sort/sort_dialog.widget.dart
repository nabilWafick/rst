...
class LocalitySortDialog extends HookConsumerWidget {
  const LocalitySortDialog({
    super.key,
  });
  @override
    ...
    return AlertDialog(
        ...
        child: Column(
          ...
          children: [
            ConstrainedBox(
              ...
              child: localitiesListParameters.containsKey('orderBy')
                  ? Consumer(
      ...
      actions: [
        Row(
          ...
          children: [
            localitiesListParameters['orderBy']?.isNotEmpty ?? false
                ? SizedBox(
                    width: 170.0,
            ...
            SizedBox(
              width: 170.0,
              child: RSTElevatedButton(
                text: localitiesListParameters['orderBy']?.isEmpty ?? false
                    ? 'Valider'
                    : 'Fermer',
                onPressed: () async {
                  Navigator.of(context).pop();

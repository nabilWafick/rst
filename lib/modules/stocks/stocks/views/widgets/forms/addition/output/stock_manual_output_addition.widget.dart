...
class StockManualOutputAdditionForm extends StatefulHookConsumerWidget {
  const StockManualOutputAdditionForm({super.key});
  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _StockManualOutputAdditionFormState();
}

class _StockManualOutputAdditionFormState
    extends ConsumerState<StockManualOutputAdditionForm> {
  @override
  void initState() {
            ...
            showValidatedButton.value
                ? SizedBox(
                    ...
                    child: RSTElevatedButton(
                      text: 'Valider',
                      onPressed: () async {
                        await StocksCRUDFunctions.createStockManualOutput(
                          context: context,
                          formKey: formKey,
                          ref: ref,

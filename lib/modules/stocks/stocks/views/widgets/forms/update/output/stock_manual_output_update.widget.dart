...
import 'package:rst/modules/stocks/stocks/views/widgets/forms/actions_confirmations/update/update.widget.dart';
import 'package:rst/utils/colors/colors.util.dart';

class StockManualOutputUpdateForm extends StatefulHookConsumerWidget {
  final Stock stock;
  const StockManualOutputUpdateForm({
    super.key,
    required this.stock,
  });
  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _StockManualOutputUpdateFormState();
}

class _StockManualOutputUpdateFormState
    extends ConsumerState<StockManualOutputUpdateForm> {
  @override
  void initState() {
            ...
            children: [
              ...
              Container(
                ...
                child: RSTTextFormField(
                  initialValue: widget.stock.outputQuantity?.toString(),
                  label: 'Quantité Sortie',
                  hintText: 'Quantité Sortie',
                  isMultilineTextForm: false,
                  obscureText: false,
                  textInputType: TextInputType.number,
                  validator: StockValidors.stockOutputQuantity,
                  onChanged: StockOnChanged.stockOutputQuantity,
                ),
              ),
            ],
          ),
                      ...
                      onPressed: () async {
                        FunctionsController.showAlertDialog(
                          ...
                          alertDialog: StockUpdateConfirmationDialog(
                            stock: widget.stock,
                            formKey: formKey,
                            update: StocksCRUDFunctions.updateStockManualOutput,
                          ),
                        );
                      },
                    ),

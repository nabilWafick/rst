...
class TransferReceivingCardBox extends StatefulHookConsumerWidget {
  final String transferName;

  const TransferReceivingCardBox({
    super.key,
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _TransferReceivingCardBoxState();
}

class _TransferReceivingCardBoxState
    extends ConsumerState<TransferReceivingCardBox> {
  @override
  Widget build(BuildContext context) {
    final cardOwner = ref.watch(
      customerSelectionToolProvider(
        widget.transferName == 'transfer-bcc'
            ...
            : '${widget.transferName}-receiving-customer',
      ),
    );
    ...
    final receivingCardTotalSettlementsNumber = useState<int>(0);
    return Container(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    CardSelectionToolCard(
                      ...
                      toolName: '${widget.transferName}-receiving-card',
                      roundedStyle: RoundedStyle.full,
                    ),
                    TypeBox(
                      customerCardType: receivingCard != null
                          ? receivingCard.type
                          : Type(
                              name: 'Type *',
                              stake: 1,
                ...
                Container(
                  ...
                  child: Wrap(
                    ...
                    children: [
                      LabelValue(
                        label: 'Nombre Type',
                        value: receivingCard != null
                            ? receivingCard.typesNumber.toString()
                            : '',
                      ),
                      LabelValue(
                        label: 'Mise Type',
                        value: receivingCard != null
                            ? receivingCard.type.stake.toInt().toString()
                            : '',
                      ),
                      Consumer(
                          ...
                          if (receivingCard != null) {
                            Future.delayed(
                              ...
                              () async {
                                ...
                                receivingCardTotalSettlementsNumber.value =
                      ...
                      Consumer(
                        builder: (context, ref, child) {
                          final amount = receivingCard != null
                              ? receivingCard.typesNumber *
                                  receivingCardTotalSettlementsNumber.value *
                                  receivingCard.type.stake.toInt()
                              : 0;
                ...
                Row(
                  ...
                  children: [
                    ...
                    Consumer(
                      builder: (context, ref, child) {
                        // get issuing card total settlements number
                        if (issuingCard != null) {
                          Future.delayed(
                            const Duration(
                              milliseconds: 100,
                        ...
                        return RSTText(
                          text: issuingCard != null && receivingCard != null
                              ? amount > 0
                                  ? '${(amount / (receivingCard.typesNumber * receivingCard.type.stake)).round()}'
                                  : '0'
                              : '',
                          fontSize: 14,
                          fontWeight: FontWeight.w500,

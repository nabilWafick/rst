...
class TransferTriggeringConfirmationDialog extends HookConsumerWidget {
  final Type type;
  ...
  const TransferTriggeringConfirmationDialog({
    super.key,
    required this.type,
      ...
      content: Container(
        ...
        child: Row(
          children: [
            ...
            const Flexible(
              child: RSTText(
                text: 'Êtes-vous sûr de vouloir déclencher ce transfer ?',
                fontSize: 15.0,

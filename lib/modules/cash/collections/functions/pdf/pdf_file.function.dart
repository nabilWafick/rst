...
Future<void> generateCollectionsPdf({
...
// hide Export button
  ...
  try {
            ...
            pw.TableRow(
              children: [
                pw.Container(
                  ...
                  child: pw.Text(
                    collections[i].amount.toInt().toString(),
                    style: pw.TextStyle(
                      font: regularFont,
                      fontSize: 7,
                    ),
                ...
                pw.Container(
                  ...
                  child: pw.Text(
                    format.format(collections[i].createdAt),
                    style: pw.TextStyle(
                      font: regularFont,
                      fontSize: 7,
                    ),
                ...
                pw.Container(
                  ...
                  child: pw.Text(
                    format.format(collections[i].updatedAt),
                    style: pw.TextStyle(
                      font: regularFont,
                      fontSize: 7,
                    ),
    ...
    final file = File('${output.path}/collectes.pdf');

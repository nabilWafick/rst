...
import 'package:rst/modules/cash/settlements/functions/excel/excel_file.function.dart';
import 'package:rst/modules/cash/settlements/providers/settlements.provider.dart';
import 'package:rst/utils/colors/colors.util.dart';

class SettlementExcelFileGenerationDialog extends HookConsumerWidget {
                    ...
                    child: RSTElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (exportAllsettlements.value) {
                          ...
                          // generate excel file
                          await generateSettlementsExcelFile(
                            context: context,
                            ref: ref,
                            listParameters: {
                              'skip': 0,

...
class CollectorActivitiesPageHeader extends StatefulHookConsumerWidget {
  const CollectorActivitiesPageHeader({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _CollectorActivitiesPageHeaderState();
}

class _CollectorActivitiesPageHeaderState
    extends ConsumerState<CollectorActivitiesPageHeader> {
  @override

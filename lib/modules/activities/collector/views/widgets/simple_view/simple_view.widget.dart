...
class CollectorActivitySimpleView extends ConsumerWidget {
  final Settlement settlement;
  const CollectorActivitySimpleView({
    super.key,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: LabelValue(
                label: 'Date Collecte',
                value: format.format(settlement.collection!.collectedAt),
              ),
            ),
            Container(
              margin: const EdgeInsetsDirectional.symmetric(
            ...
            Container(
              ...
              child: LabelValue(
                label: 'Collecteur',
                value:
                    '${settlement.collection!.collector.name} ${settlement.collection!.collector.firstnames}',
              ),
            ),
            Container(
              margin: const EdgeInsetsDirectional.symmetric(
